...
public class CSVNLineInputFormat extends FileInputFormat<LongWritable, List<Text>> {
    ...
    public List<InputSplit> getSplits(Job job) throws IOException {
	...
	protected boolean isSplitable(Job context, Path filename) {
		return true;
	}
	...
	public static int getNumLinesPerSplit(Job job) {
